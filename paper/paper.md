...
- **SDSS-V Local Volume Mapper (LVM).** The LVM Data Analysis Pipeline [DAP; @Sanchez:2025] extend the MaNGA framework to parsec-scale mapping of the Milky Way and nearby galaxies, combining calibration, data fusion, and distributed analysis optimized for wide-field mosaics.
