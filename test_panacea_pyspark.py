...
def getAmplifiers(filename_full_path):
...
def main():
    ...
    raw_twi = sc.parallelize(filelist_twi).mapValues(getAmplifiers)
    ...
    # Initialize the amplifier class and make rdd with file names as key
    # and Amplifier class object as value
    raw_sci = sc.parallelize(filelist_sci).mapValues(getAmplifiers)
