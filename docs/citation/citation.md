...
If you use Panacea in your research, please cite it. The citation metadata is provided below (mirrored from the repository root CITATION.cff) so it is available directly within the docs site.
...
authors:
  - family-names: Zeimann
    ...
    orcid: https://orcid.org/0000-0003-2307-0629
repository-code: https://github.com/grzeimann/Panacea
keywords:
  - astronomy
  - spectroscopy
  - data reduction
